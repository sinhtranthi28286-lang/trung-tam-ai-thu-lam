...
- **FAIL — Inline handlers defined**: openMonthlySheet, reloadMonthlySheet
...
- **INFO — Supabase tables referenced**: admin_users, ai_areas, ai_tasks, app_files, app_permissions, app_shared_state, app_users, kho-nghiep-vu-so, staff_members
...
- **INFO — App version**: 8.29
- **INFO — External scripts**: https://cdnjs.cloudflare.com/ajax/libs/pdf.js/3.11.174/pdf.min.js; https://cdnjs.cloudflare.com/ajax/libs/mammoth/1.6.0/mammoth.browser.min.js; https://cdn.jsdelivr.net/npm/@supabase/supabase-js@2
